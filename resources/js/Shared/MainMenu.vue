<template>
  <div>
    ...
    <div class="mb-4">
      <Link class="flex items-center py-3 group" href="/tickets">
        <icon name="printer" class="w-4 h-4 mr-2" :class="isUrl('tickets') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
